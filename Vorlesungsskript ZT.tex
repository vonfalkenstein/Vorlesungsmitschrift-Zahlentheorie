...
\newcommand{\file}[1]{%
	\stepcounter{file}
	\marginnote{Datei \thefile}
	\addxcontentsline{listoffiles}{section}[\thefile]{Datei \thefile{} - {#1}}
}
\newcommand{\lecturefile}[1]{%
	\stepcounter{file}
	\stepcounter{lecture}
	\marginnote{Vorlesung \thelecture\\Datei \thefile}
	\addxcontentsline{listoflectures}{section}[\thelecture]{Vorlesung \thelecture}
	\addxcontentsline{listoffiles}{section}[\thefile]{Datei \thefile{} - {#1}}
}
